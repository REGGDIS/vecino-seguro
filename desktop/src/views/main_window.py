...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        central.setStyleSheet("QWidget#central { background-color: #F5F7FA; }")
        ...
        lbl_brand_b.setStyleSheet(
            "color: #34A853; font-size: 18px; font-weight: 800; "
            "background: transparent; border: none;"
        )
        ...
        btn_logout.setStyleSheet("""
            ...
            QPushButton:hover { color: #FFFFFF; background-color: rgba(229,62,62,0.3); }
        """)
        ...
        self.content_area.setStyleSheet("background-color: #F5F7FA;")
        ...
        self.lbl_chip.setStyleSheet(
            "background-color: #E5F4EA; color: #2C8C46; "
    ...
    def _mk_sidebar_btn(self, texto: str, on_click) -> QPushButton:
        ...
        b.setStyleSheet("""
            ...
            QPushButton:hover {
                color: #FFFFFF; background-color: rgba(27,79,140,0.4);
            }
            QPushButton:checked {
                color: #FFFFFF; background-color: rgba(27,79,140,0.6);
                border-left: 3px solid #34A853; font-weight: 600;
            }
        """)
