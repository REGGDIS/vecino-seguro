...
class DashboardView(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.lbl_subtitulo.setStyleSheet("color: #6B7280; font-size: 14px;")
        ...
        self.kpi_pendientes = self._mk_kpi("0", "Pendientes",  "#DD6B20")
        self.kpi_revision   = self._mk_kpi("0", "En revisión", "#1B4F8C")
        self.kpi_atendidos  = self._mk_kpi("0", "Atendidos",   "#34A853")
        self.kpi_resueltos  = self._mk_kpi("0", "Resueltos",   "#4A5568")
        ...
        acciones_layout.addWidget(self._mk_action_card(
            ...
            "#34A853", self.ir_a_registrar.emit,
        ))
        acciones_layout.addWidget(self._mk_action_card(
            "📋", "Ver todos los reportes",
            "Revisa el listado completo de incidentes",
            "#1B4F8C", self.ir_a_listado.emit,
        ))
    ...
    def _mk_reciente_row(self, emergencia) -> QFrame:
        ...
        color_urg = {
            ...
            "Media": "#D69E2E",   "Baja": "#34A853",
        }.get(emergencia.nivel_urgencia.value, "#6B7280")
        dot = QLabel()
        dot.setStyleSheet(
        ...
        # Badge de estado con estilo inline (más confiable que QSS por property)
        estilos_badge = {
        ...
        bg, fg = estilos_badge.get(emergencia.estado.value, ("#E2E8F0", "#4A5568"))
        badge = QLabel(emergencia.estado.value)
        badge.setStyleSheet(
